...
"""
if nxy % 2 == 1:
    print("Sent data: ", (nxy+1)/2 + d1)
    rec2 = (nxy+1)/2 + d1 - len(passedRouteList) + 1
    print("Recieved data: ", rec2)
else:
    print("Sent data: ", (nxy)/2 + d1)
    rec2 =  nxy/2 + d1
    print("Recieved data: ", rec2)
"""
...
print("Sent data: ", nxy+8+d2)
rec1 = nxy+8+d2 - len(passedRouteListR1) + 1
print("Recieved data: ", rec1)
"""
...
"""
if nxy % 2 == 1:
    print("Sent data: ", (3*nxy-1)/2+d3)
    rec3 = (3*nxy-1)/2+d3 - len(passedRouteListR3) + 1
    print("Recieved data: ", rec3)
else:
    print("Sent data: ", (3*nxy)/2+d3)
    rec3 = (3*nxy)/2+d3 - len(passedRouteListR3) + 1
    print("Recieved data: ", rec3)
"""
